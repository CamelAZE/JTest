...
<script type="text/javascript">
	...
	$(document).ready(function(){
        try{
            ...
            if(seSawonid == ""){        //  ºÎ¸ð Ã¢¿¡¼­ Á¤º¸ À¯ÁöÁßÀÎÁö È®ÀÎ
                ...
                // ------------------------------------------------------------------------
                // autocomplete Ç°¸í °Ë»ö ÀÛ¾÷¿Ï·á ÆäÀÌÁö ºÒ·¯¿Ã¶§ ·Îµù¹®Á¦·Î µÎ°÷¿¡¼­ ³ª´²¼­ Á¶°Çº° ½ÇÇà
                // ------------------------------------------------------------------------
                // var item_json = Get_Json("EXEC AA_WORKDIARY_Search '', 'Ç°¸í', ''");
                // item_sql = item_json;
            ...
            $("#ÀÛ¾÷Ãë¼Ò").on("click", function(){
                if(confirm("Á¤¸» Ãë¼ÒÇÏ½Ã°Ú½À´Ï±î ?") == true){
                    if($("#ÀÛ¾÷½ÃÀÛ½Ã°£").val() == ""){     //  ÀÛ¾÷½ÃÀÛ½Ã°£ À¯¹«·Î ÀÛ¾÷ ½ÃÀÛ È®ÀÎ
                        ...
                        var delGubun = "1";         //  1 : ¾ÐÃâ, 2 : ÇÕÆ÷, 3 : ÄÚÆÃ, 4 : ºÐ´Ü, 5 : Àç´Ü
            ...
            $("input").on("keydown", function(e){
                ...
                if(key == 13){      //  ¿£ÅÍ Å°ÄÚµå°ª 13
                    if($(this).hasClass("input-auto") == true){     //  autocomplete ÀÛµ¿ÇÏ´Â°÷¿¡¼± ¹ÌÀÛµ¿ÇÏµµ·Ï
                        e.preventDefault();
                    }else{
                        move_next(this);
                    };
            ...
            // ------------------------------------------------------------------------
            // autocomplete Ç°¸í °Ë»ö ÆäÀÌÁî ·Îµå½Ã ¹Ù·Î½ÇÇà
            // ------------------------------------------------------------------------
            item_sql = "" // ¾ÆÀÌÅÛ ·¹ÄÚµå¼Â Àü¿ªº¯¼ö
            var item_json = Get_Json_common_direct("EXEC [AA_WORKDIARY_Search2] '', 'Ç°¸í', ''");
            ...
            $(".input-number").on("blur keyup", function(){
                ...
                $(this).val($(this).val().replace(regex, ""));      //  ÀÌ °ªÀÌ regex¸é ""·Î ¹Ù²ã¹ö¸®±â
            });   //  ¼ýÀÚ¸¸ ÀÔ·Â end
    ...
    function init_disp(id){
        try{
            var rst = Get_Json("B_WORK_LST 'G_WorkDiary_¾ÐÃâ', " + id);		//	µ¥ÀÌÅÍ °¡Á®¿Àµµ·Ï sql ½ÇÇà
    ...
    function work_check(war_name ,work_date, worker){
        try{
            var rst = Get_Json("B_WORK_CHECK 'G_WorkDiary_¾ÐÃâ', '" + war_name + "', '" + work_date + "', '" + worker + "'");
    ...
    function remain_disp(id){
        try{
            var rst = Get_Json("B_WORK_LST_REMAIN 'G_WorkDiary_¾ÐÃâ'," + id);		//	¾ÐÃâÅ×ÀÌºí¿¡ ÀúÀåµÈ µ¥ÀÌÅÍÁß ÁøÇàÁßÀÎ µ¥ÀÌÅÍ ¹ÝÈ¯
    ...
    function data_find(id, item_sql){
        try{
            ...
            var color = "";
            var size = "";
            if(id == "Àåºñ±¸ºÐ"){		//	Àåºñ±¸ºÐ ÀÇ °æ¿ì °Ë»ö¾î·Î E% ¸¦ °°ÀÌ º¸³»¼­ ´Ù¸¥ ÆäÀÌÁö¿¡¼­µµ sp¾È¿¡¼­ °¥¶óÁöÁö ¾Êµµ·Ï È°¿ë
                t_sql = "EXEC AA_WORKDIARY_Search 'E%', '" + id + "', ''";
            }else if(id == "³¯¾¾"){		//	³¯¾¾ÀÇ °æ¿ì ½ÇÇà sql¹® ÁöÁ¤
                t_sql = "EXEC AA_WORKDIARY_Search '', '" + id + "', ''";
            }else if(id == "Ä®¶ó" || id == "±Û·çÄ®¶ó" || id == "¿ø´ÜÄ®¶ó1" || id == "¿ø´ÜÄ®¶ó2" || id == "¿ø´ÜÄ®¶ó3" || id == "¿ø´ÜÄ®¶ó4"){		//	Ä®¶óid¿¡ ¸ÂÃç Ç°¸í id º¯°æ
                item = id == "Ä®¶ó" ? "Ç°¸í" : id == "±Û·çÄ®¶ó" ? "±Û·çÇ°¸í" : id == "¿ø´ÜÄ®¶ó1" ? "¿ø´ÜÇ°¸í1" : id == "¿ø´ÜÄ®¶ó2" ? "¿ø´ÜÇ°¸í2" : id == "¿ø´ÜÄ®¶ó3" ? "¿ø´ÜÇ°¸í3" : "¿ø´ÜÇ°¸í4";
                if($("#" + item).val() == ""){
            ...
            }else if(id == "»çÀÌÁî" || id == "±Û·ç»çÀÌÁî" || id == "¿ø´Ü»çÀÌÁî1" || id == "¿ø´Ü»çÀÌÁî2" || id == "¿ø´Ü»çÀÌÁî3" || id == "¿ø´Ü»çÀÌÁî4"){		//	»çÀÌÁîid¿¡ ¸ÂÃç Ç°¸í id º¯°æ
                item = id == "»çÀÌÁî" ? "Ç°¸í" : id == "±Û·ç»çÀÌÁî" ? "±Û·çÇ°¸í" : id == "¿ø´Ü»çÀÌÁî1" ? "¿ø´ÜÇ°¸í1" : id == "¿ø´Ü»çÀÌÁî2" ? "¿ø´ÜÇ°¸í2" : id == "¿ø´Ü»çÀÌÁî3" ? "¿ø´ÜÇ°¸í3" : "¿ø´ÜÇ°¸í4";
                color = id == "»çÀÌÁî" ? "Ä®¶ó" : id == "±Û·ç»çÀÌÁî" ? "±Û·çÄ®¶ó" : id == "¿ø´Ü»çÀÌÁî1" ? "¿ø´ÜÄ®¶ó1" : id == "¿ø´Ü»çÀÌÁî2" ? "¿ø´ÜÄ®¶ó2" : id == "¿ø´Ü»çÀÌÁî3" ? "¿ø´ÜÄ®¶ó3" : "¿ø´ÜÄ®¶ó4";
                if($("#" + item).val() == ""){
                    dontFocus = 1;      // ÀÚµ¿¿Ï¼º È­»ìÇ¥ Æ®¸®°Å¸¸ ÀÛµ¿ÇÏµµ·Ï ÀÛ¾÷
                    alert("Ç°¸íÀ» ÀÔ·ÂÇØ ÁÖ¼¼¿ä.");
                    $("#" + item).focus();
            ...
            }else if(id == "±Û·ç·ÎÆ®¹øÈ£" || id == "¿ø´Ü·ÎÆ®¹øÈ£1" || id == "¿ø´Ü·ÎÆ®¹øÈ£2" || id == "¿ø´Ü·ÎÆ®¹øÈ£3" || id == "¿ø´Ü·ÎÆ®¹øÈ£4"){		//	·ÎÆ®¹øÈ£ ¼ø¹ø¿¡ µû¶ó ¿¬°áÇÏ´Â Ç°¸í, Ä®¶ó, »çÀÌÁî º¯°æ
                item = id == "±Û·ç·ÎÆ®¹øÈ£" ? "±Û·çÇ°¸í" : id == "¿ø´Ü·ÎÆ®¹øÈ£1" ? "¿ø´ÜÇ°¸í1" : id == "¿ø´Ü·ÎÆ®¹øÈ£2" ? "¿ø´ÜÇ°¸í2" : id == "¿ø´Ü·ÎÆ®¹øÈ£3" ? "¿ø´ÜÇ°¸í3" : "¿ø´ÜÇ°¸í4";
                color = id == "±Û·ç·ÎÆ®¹øÈ£" ? "±Û·çÄ®¶ó" : id == "¿ø´Ü·ÎÆ®¹øÈ£1" ? "¿ø´ÜÄ®¶ó1" : id == "¿ø´Ü·ÎÆ®¹øÈ£2" ? "¿ø´ÜÄ®¶ó2" : id == "¿ø´Ü·ÎÆ®¹øÈ£3" ? "¿ø´ÜÄ®¶ó3" : "¿ø´ÜÄ®¶ó4";
                size = id == "±Û·ç·ÎÆ®¹øÈ£" ? "±Û·ç»çÀÌÁî" : id == "¿ø´Ü·ÎÆ®¹øÈ£1" ? "¿ø´Ü»çÀÌÁî1" : id == "¿ø´Ü·ÎÆ®¹øÈ£2" ? "¿ø´Ü»çÀÌÁî2" : id == "¿ø´Ü·ÎÆ®¹øÈ£3" ? "¿ø´Ü»çÀÌÁî3" : "¿ø´Ü»çÀÌÁî4";
                if($("#" + item).val() == "" || $("#" + color).val() == "" || $("#" + size).val() == ""){
                    dontFocus = 1;      // ÀÚµ¿¿Ï¼º È­»ìÇ¥ Æ®¸®°Å¸¸ ÀÛµ¿ÇÏµµ·Ï ÀÛ¾÷
                    alert("·ÎÆ®¹øÈ£¸¦ È®ÀÎÇÏ±â À§ÇØ\nÀÌÇüÁö ¶Ç´Â ÅõÀÔÇ° ÀÔ·Â Á¤º¸¸¦ ÀçÈ®ÀÎ ÇØÁÖ¼¼¿ä.");
                    var focus = $("#" + item).val() == "" ? item : $("#" + color).val() == "" ? color : size;
                    $("#" + focus).focus();
                    return false;
                }else{
                    t_sql = "EXEC [AA_WORKDIARY_LOTNO] '', '" + $("#ÀÛ¾÷ÀÚ").val() + "', '" + $("#" + item).val() + "', '" + $("#" + color).val() + "', '" + $("#" + size).val() + "', '¾ÐÃâÃ¢°í'";
                };
            };
            var find_rst = "";		//	½ÇÇà½ÃÅ³ sql¹® ´ãÀ» º¯¼ö »ý¼º
            var find_data_array = new Array();		//	sqlÀÇ Á¤º¸ ¹ÝÈ¯ ¹ÞÀ» µ¥ÀÌÅÍ Array »ý¼º
            if(id == "Ç°¸í" || id == "±Û·çÇ°¸í" || id == "¿ø´ÜÇ°¸í1" || id == "¿ø´ÜÇ°¸í2" || id == "¿ø´ÜÇ°¸í3" || id == "¿ø´ÜÇ°¸í4"){
                find_rst = item_sql;		//	Ç°¸íÀÇ °æ¿ì ÆäÀÌÁö ·Îµå½Ã ¹Ù·Î sql ½ÇÇàÇÏ¿© ´ã¾ÆµÎ¾î ÇÔ¼ö ½ÇÇà º¯¼ö·Î ¹Þ¾Æ¿Â°Í »ç¿ë
            }else if(id == "±Û·ç·ÎÆ®¹øÈ£" || id == "¿ø´Ü·ÎÆ®¹øÈ£1" || id == "¿ø´Ü·ÎÆ®¹øÈ£2" || id == "¿ø´Ü·ÎÆ®¹øÈ£3" || id == "¿ø´Ü·ÎÆ®¹øÈ£4"){
            ...
            if(id == "±Û·ç·ÎÆ®¹øÈ£" || id == "¿ø´Ü·ÎÆ®¹øÈ£1" || id == "¿ø´Ü·ÎÆ®¹øÈ£2" || id == "¿ø´Ü·ÎÆ®¹øÈ£3" || id == "¿ø´Ü·ÎÆ®¹øÈ£4"){
    ...
    function autocomplete_dbc(find_data_array, id){
        try {
            $("#" + id + "").autocomplete({    // autocomplete ½ÃÀÛ
                ...
                // maxShowItems : 5,    // ÃÖ´ë º¸¿©ÁÖ´Â ¾ÆÀÌÅÛ ¼ö
    ...
    // ------------------------------------------------------------------------
    // ÇÊ¼ö ÀÔ·Â ¿ä¼Ò È®ÀÎ    0 À¸·Î kind ¹ÞÀ¸¸é ¾Õ¿¡¸¸(ÀÛ¾÷½ÃÀÛ) 1 ·Î kind ¹ÞÀ¸¸é µÚ¿¡±îÁö(ÀÛ¾÷Á¾·á)   SP¿¡¼­ È®ÀÎÇÏ´Â°ÍÀ¸·Î º¯°æÇÏ¿© ¹Ì»ç¿ë
    // ------------------------------------------------------------------------
        ...
        try{
            ...
            for(i = 0; i < className.length; i++){
                if(className[i].value == ""){
                    alert($("label[for='" + className[i].id + "']").text() + "Àº(´Â) ÇÊ¼ö ÀÔ·Â Ç×¸ñÀÔ´Ï´Ù.");
                    $("#" + className[i].id + "").focus();
                return false;
                };
            };    //  ÀÛ¾÷½ÃÀÛ½Ã (Àåºñ, »ý»êÇ°¸í, »ý»êÄ®¶ó, »ý»ê»çÀÌÁî) ÀÔ·Â¿©ºÎ end
            if(kind > 0){
                var className = $(".must_02");
                for(i = 0; i < className.length; i++){
                    if(className[i].value == "" || className[i].value == 0){
                        if(className[i].id == "»ý»ê¼ö·®"){
                            alert("»ý»ê¼ö·®Àº(´Â) ÇÊ¼ö ÀÔ·Â Ç×¸ñÀÔ´Ï´Ù.");
                            $("#»ý»ê·Ñ±æÀÌ1").focus();
                            return false;
                        };
                        alert($("label[for='" + className[i].id + "']").text() + "Àº(´Â) ÇÊ¼ö ÀÔ·Â Ç×¸ñÀÔ´Ï´Ù.");
                ...
                };    //  ÀÛ¾÷Á¾·á½Ã (»ý»ê¼ö·®, ÀÌÇüÁö¸í, ÀÌÇüÁöÄ®¶ó, ÀÌÇüÁö»çÀÌÁî, ÀÌÇüÁö¼ö·®, ÅõÀÔÇ°¸í, ÅõÀÔÄ®¶ó, ÅõÀÔ»çÀÌÁî, ÅõÀÔ¼ö·®) ÀÔ·Â¿©ºÎ end
                inven_check();
            };    //  Á¾·á½Ã ÅõÀÔÇ°±îÁö È®ÀÎ (kind = 1 ÀÎ °æ¿ì) end
            return true;
        }catch(err){
            alert(err.message);
        };
    };    //  ÇÊ¼öÀÔ·Â ¿ä¼Ò È®ÀÎ end
    ...
    function stock_chk(item, color, size, cnt){
        try{
            ...
            var wareID = 5;   //    5 : ¾ÐÃâÃ¢°í, 7 : ÇÕÆ÷Ã¢°í, 6 : ÄÚÆÃÃ¢°í
    ...
    function auto_set(item, color, size, count){
        try{
            var rst = Get_Json("[B_WORK_Auto_MAT] 'G_WorkDiary_¾ÐÃâ','"
                                    + item    + "','"
                                    + color    + "','"
                                    + size   + "'");
        ...
        try{
            ...
            $('.input-field, .input-number').each(function(){
                if($(this).attr("type") == "text" || $(this).attr("type") == "date" || $(this).attr("type") == "hidden" || $(this).attr("type") == "textarea"){
                    t_val = $(this).val();
                }else if($(this).attr("type") == "checkbox"){       //  ¾ø¾îµµ µÇ´Â Ç×¸ñ Àç´Ü µî ¿¡¼­ »ç¿ë
                ...
                //     save_data += ", " + t_val + "'";
                // };
                if(this.id.includes("¿Âµµ") || this.id.includes("HEAD")){       // ¿ÀÀü¿Âµµ, ¿ÀÈÄ¿Âµµ, HEAD¾Ð·Â, HEAD½ÇÃø ¼Ò¼öÁ¡ ÀúÀå À§ÇØ¼­ '' ¾È°¨½Î°í º¸³»±â
                    if(t_val == "" || t_val == " "){        // ÀÔ·Â°ª ¾ø´Â°Í Á¦¾î±¸¹®
                        save_data += ", " + 0;
                    }else{
                        var chk_num = Get_Json("SELECT ISNUMERIC(" + t_val + ") AS TF");        // ¼ýÀÚÀÎÁö È®ÀÎÇÏ±â
                        if(chk_num[0].TF == 1){     // ¼ýÀÚÀÎ°æ¿ì
                            save_data += ", " + t_val;
                        }else{      // ¾Æ´Ñ°æ¿ì
                            save_data += ", " + 0;
                        };
            ...
            // var oldGlu_array = $(".oldGlu");   //  Àç°íÃ¼Å© sp¿¡¼­ ½ÇÇàÇÒ °æ¿ì ¿Ãµå ±Û·ç °°ÀÌ º¸³»±â
            // for(i = 0; i < oldGlu_array.length; i++){
            //   t_val = oldGlu_array[i].value;
            //   save_data += ", '" + t_val + "'";
            // };
            console.log("EXEC [AA_WORKDIARY_¾ÐÃâ] '" + id + "', '" + WorkID + "'" + save_data);
            var insert = Get_Json("EXEC [AA_WORKDIARY_¾ÐÃâ] '" + id + "', '" + WorkID + "'" + save_data + "");		//	save_data ¼±¾ð½Ã ¸¶Áö¸·¿¡ ' Æ÷ÇÔµÇ¾îÀÖ¾î ' ÀÖÀ¸¸é ¿À·ù¹ß»ý
    ...
    <div class="bottom">
        <div class="date_insert">
            <table class="date">
                <tr>
                    <th class="th_01">
                        <label class="label_tag" for="ÀÛ¾÷ÀÏÀÚ">ÀÛ¾÷ÀÏÀÚ</label>
                    </th>
                    <td class="td_01" colspan="2;">
                        <input type="text" id="ÀÛ¾÷ÀÏÀÚ" class="input_tag input_tag_date input-field input_date must_01 datepicker" autocomplete="off">
                    </td>
                    ...
                    <th class="th_01">
                        <label class="label_tag" for="Àåºñ±¸ºÐ">Àåºñ</label>
                    </th>
                    <td class="td_01" colspan="2;">
                        <input type="text" id="Àåºñ±¸ºÐ" class="input_tag input-field input-auto input-auto_a must_01" autocomplete="off">
                    </td>
                ...
                <tr>
                    ...
                    <td class="td_01 td_temp_01">
                        <input type="text" id="¿ÀÀü¿Âµµ" class="input_tag input_tag_temp_01 input-number set-date" step="0.1" autocomplete="off"><span>&#176;C</span>
                    </td>
                    <td class="td_01 td_temp_01">
                        <input type="text" id="¿ÀÈÄ¿Âµµ" class="input_tag input_tag_temp_01 input-number set-date" step="0.1" autocomplete="off"><span>&#176;C</span>
                    </td>
                    ...
                    <td class="td_01 td_temp_01">
                        <input type="text" id="¿ÀÀü½Àµµ" class="input_tag input_tag_temp_01 input-number set-date" step="0.1" autocomplete="off"><span>%</span>
                    </td>
                    <td class="td_01 td_temp_01">
                        <input type="text" id="¿ÀÈÄ½Àµµ" class="input_tag input_tag_temp_01 input-number set-date" step="0.1" autocomplete="off"><span>%</span>
                    </td>

                    <th class="th_01">
                        <label class="label_tag" for="ºñ°í">ºñ°í</label>
                    </th>
                    <td class="td_01" colspan="2;">
                        <input type="text" id="ºñ°í" class="input_tag input_tag_end_01 input-field" autocomplete="off">
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="item_insert">
            <table class="item">
                <tr>
                    <th class="th_01">
                        <label class="label_tag" for="Ç°¸í">»ý»êÇ°¸í</label>
                    </th>
                    <td class="td_01" colspan="2;">
                        <input type="text" id="Ç°¸í" class="input_tag input-field input-auto input-auto_a must_01" autocomplete="off">
                    </td>
                        
                    <th class="th_01">
                        <label class="label_tag" for="Ä®¶ó">Ä®¶ó</label>
                    </th>
                    <td class="td_01" colspan="2;">
                        <input type="text" id="Ä®¶ó" class="input_tag input-field input-auto input-auto_b must_01" autocomplete="off">
                    </td>
                    
                    <th class="th_01">
                        <label class="label_tag" for="»çÀÌÁî">»çÀÌÁî</label>
                    </th>
                    <td class="td_01" colspan="2;">
                        <input type="text" id="»çÀÌÁî" class="input_tag input-field input-auto input-auto_b must_01" autocomplete="off">
                    </td>
                ...
                <tr>
                    ...
                    <td class="td_01 td_prod_02">
                        <input type="text" id="»ý»ê·Ñ¼ö·®2" class="input_tag input_tag_prod_02 input-number auto_sum" autocomplete="off">
                    </td>
                    ...
                    <td class="td_01 td_prod_02">
                        <input type="text" id="»ý»ê·Ñ¼ö·®3" class="input_tag input_tag_prod_02 input-number auto_sum" autocomplete="off">
                    </td>
                    ...
                    <td class="td_01 td_prod_02">
                        <input type="text" id="»ý»ê·Ñ¼ö·®4" class="input_tag input_tag_prod_02 input_tag_end_01 input-number auto_sum" autocomplete="off">
                    </td>
                </tr>

                <tr>
                    <th class="th_01">
                        <label class="label_tag">»ý»ê±æÀÌ 5</label>
                    </th>
                    <td class="td_01 td_prod_01">
                        <input type="text" id="»ý»ê·Ñ±æÀÌ5" class="input_tag input_tag_prod_01 input-number auto_sum" autocomplete="off">
                    </td>
                    <td class="td_01 td_prod_02">
                        <input type="text" id="»ý»ê·Ñ¼ö·®5" class="input_tag input_tag_prod_02 input-number auto_sum" autocomplete="off">
                    </td>

                    <th class="th_01">
                        <label class="label_tag">»ý»ê±æÀÌ 6</label>
                    </th>
                    <td class="td_01 td_prod_01">
                        <input type="text" id="»ý»ê·Ñ±æÀÌ6" class="input_tag input_tag_prod_01 input-number auto_sum" autocomplete="off">
                    </td>
                    <td class="td_01 td_prod_02">
                        <input type="text" id="»ý»ê·Ñ¼ö·®6" class="input_tag input_tag_prod_02 input-number auto_sum" autocomplete="off">
                    </td>

                    <th class="th_01">
                        <label class="label_tag">»ý»ê±æÀÌ 7</label>
                    </th>
                    <td class="td_01 td_prod_01">
                        <input type="text" id="»ý»ê·Ñ±æÀÌ7" class="input_tag input_tag_prod_01 input-number auto_sum" autocomplete="off">
                    </td>
                    <td class="td_01 td_prod_02">
                        <input type="text" id="»ý»ê·Ñ¼ö·®7" class="input_tag input_tag_prod_02 input-number auto_sum" autocomplete="off">
                    </td>

                    <th class="th_01">
                        <label class="label_tag" for="»ý»ê¼ö·®">»ý»ê¼ö·®</label>
                    </th>
                    <td class="td_01" colspan="2;">
                        <input type="text" id="»ý»ê¼ö·®" class="input_tag input_tag_readonly_01 input_tag_end_01 input-number must_02" tabindex="-1" readonly>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="machine_insert">
            <table class="machine">
                <tr>
                    ...
                    <th class="th_01">
                        <label class="label_tag">UN_W ÅÙ¼Ç</label>
                    </th>
                    <td class="td_01" colspan="2;">
                    ...
                    <th class="th_01">
                        <label class="label_tag">RE_W ÅÙ¼Ç</label>
                    </th>
                    <td class="td_01" colspan="2;">
                ...
                <tr>
                    <th class="th_01">
                        <label class="label_tag">È÷ÅÍ(&#176;C)</label>
                    </th>
                    <td class="td_01 td_machine_01">
                        <span>&nbsp;1¹ø&nbsp;</span><input type="text" id="HEATER1" class="input_tag input_tag_machine_01 input-number machine-set" autocomplete="off">
                    </td>
                    <td class="td_01 td_machine_01">
                        <span>&nbsp;2¹ø&nbsp;</span><input type="text" id="HEATER2" class="input_tag input_tag_machine_01 input-number machine-set" autocomplete="off">
                    </td>
                    ...
                    <td class="td_01 td_machine_01">
                        <span>&nbsp;Á¦½À&nbsp;</span><input type="text" id="Á¦½À¿Âµµ" class="input_tag input_tag_machine_02 input-number machine-set" autocomplete="off">
                    </td>
                    <td class="td_01 td_machine_01">
                        <span>&nbsp;³ëÁ¡&nbsp;</span><input type="text" id="³ëÁ¡" class="input_tag input_tag_machine_02 input-number machine-set" autocomplete="off">
                    </td>


                    <th class="th_01">
                        <label class="label_tag">ÇÔ¼öÀ²(%)</label>
                    </th>
                    <td class="td_01" colspan="2;">
                        <input type="text" id="ÇÔ¼öÀ²" class="input_tag input-number" autocomplete="off">
                    </td>

                    <th class="th_01">
                        <label class="label_tag">³Ãµ¿¼³Á¤(&#176;C)</label>
                    </th>
                    <td class="td_01" colspan="2;">
                        <input type="text" id="³Ãµ¿¼³Á¤¿Âµµ" class="input_tag input_tag_end_01 input-number" autocomplete="off">
                    </td>
                </tr>
            </table>
            ...
            <table class="machine">
                <tr>
                    <th class="th_01 th_press_01" rowspan="2">
                        <label class="label_tag label_tag_2row">¾ÐÃâÁ¶°Ç</label>
                    </th>
                    ...
                    <th class="th_01 th_press_02">
                        <label class="label_tag">¾Ð·Â</label>
                    </th>
                    <td class="td_01 td_press_01">
                        <input type="text" id="HEAD¾Ð·Â" class="input_tag input_tag_press_01 input-number machine-set" autocomplete="off">
                    </td>
                    <th class="th_01 th_press_02">
                        <label class="label_tag">½ÇÃø</label>
                    </th>
                    <td class="td_01 td_press_01">
                        <input type="text" id="HEAD½ÇÃø" class="input_tag input_tag_press_01 input-number machine-set" autocomplete="off">
                    </td>
                    <th class="th_01 th_press_02">
            ...
            <table class="machine">
                <tr>
                    <th class="th_01 th_cut_01">
                        <label class="label_tag">ÄÆÆÃÆø cm(1)</label>
                    </th>
                    <td class="td_01 td_cut_01">
                        <input type="text" id="ÄÆÆÃÆøCM1" class="input_tag input_tag_cut_01 input-number machine-set" autocomplete="off">
                    </td>
                        
                    <th class="th_01 th_cut_01">
                        <label class="label_tag">ÄÆÆÃÆø cm(7)</label>
                    </th>
                    <td class="td_01 td_cut_01">
                        <input type="text" id="ÄÆÆÃÆøCM7" class="input_tag input_tag_cut_01 input-number machine-set" autocomplete="off">
                    </td>
                    
                    <th class="th_01 th_cut_01">
                        <label class="label_tag">ÄÆÆÃºÎ ¹«°Ô kg(1)</label>
                    </th>
                    <td class="td_01 td_cut_01">
                        <input type="text" id="ÄÆÆÃºÎ¹«°ÔKG1" class="input_tag input_tag_cut_01 input-number machine-set" autocomplete="off">
                    </td>
                    
                    <th class="th_01 th_cut_01">
                        <label class="label_tag">ÄÆÆÃºÎ ¹«°Ô kg(7)</label>
                    </th>
                    <td class="td_01 td_cut_01">
                        <input type="text" id="ÄÆÆÃºÎ¹«°ÔKG7" class="input_tag input_tag_cut_01 input-number machine-set" autocomplete="off">
                    </td>
                    
                    <th class="th_01 th_cut_01">
                        <label class="label_tag">ÄÆÆÃ ÃÑ ±æÀÌ (m)</label>
                    </th>
                    <td class="td_01 td_cut_01">
                        <input type="text" id="ÄÆÆÃÃÑ±æÀÌM" class="input_tag input_tag_cut_01 input-number machine-set" autocomplete="off">
                    </td>
                </tr>

                <tr>
                    <th class="th_01 th_cut_01">
                        <label class="label_tag">¹Ð¾î³»±â Áß·® (m)</label>
                    </th>
                    <td class="td_01 td_cut_01">
                        <input type="text" id="¹Ð¾î³»±âÁß·®" class="input_tag input_tag_cut_01 input-number machine-set" autocomplete="off">
                    </td>
                        
                    <th class="th_01 th_cut_01">
                        <label class="label_tag">Á¶°Ç¼ÂÆÃ ±æÀÌ (m)</label>
                    </th>
                    <td class="td_01 td_cut_01">
                        <input type="text" id="Á¶°Ç¼ÂÆÃ±æÀÌ" class="input_tag input_tag_cut_01 input-number machine-set" autocomplete="off">
                    </td>
                    
                    <th class="th_01 th_cut_01">
                        <label class="label_tag">¼ÂÆÃ Áß·® (kg)</label>
                    </th>
                    <td class="td_01 td_cut_01">
                        <input type="text" id="Á¶°Ç¼ÂÆÃÁß·®" class="input_tag input_tag_cut_01 input-number machine-set" autocomplete="off">
                    </td>

                    <th class="th_01 th_cut_01">
                        <label class="label_tag">¼ÂÆÃ Æø (mm)</label>
                    </th>
                    <td class="td_01 td_cut_01">
                        <input type="text" id="Á¶°Ç¼ÂÆÃÆø" class="input_tag input_tag_cut_01 input-number machine-set" autocomplete="off">
                    </td>

                    <th class="th_01 th_cut_01">
                        <label class="label_tag">¼ø¼öÀÌÇüÁö LOSS (m)</label>
                    </th>
                    <td class="td_01 td_cut_01">
                        <input type="text" id="¼ø¼öÀÌÇüÁöLOSS" class="input_tag input_tag_cut_01 input-number machine-set" autocomplete="off">
                    </td>
                    
                    <th class="th_01 th_cut_01" colspan="2;">
                        <label class="label_tag">±âÅ¸ Loss</label>
                    </th>
                    <td class="td_01 td_cut_01" colspan="2;">
                        <input type="text" id="±âÅ¸LOSS" class="input_tag input_tag_cut_01 input_tag_end_03 input-number machine-set" autocomplete="off">
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="ingredient_insert">
            <table class="ingredient">
                <tr>
                    <th class="th_01">
                        <label class="label_tag" for="±Û·çÇ°¸í">ÀÌÇüÁö¸í</label>
                    </th>
                    <td class="td_01">
                        <input type="text" id="±Û·çÇ°¸í" class="input_tag input-field auto-mat input-auto input-auto_a must_02 must_03_01" autocomplete="off">
                    </td>
                        
                    <th class="th_01">
                        <label class="label_tag" for="±Û·çÄ®¶ó">Ä®¶ó</label>
                    </th>
                    <td class="td_01">
                        <input type="text" id="±Û·çÄ®¶ó" class="input_tag input-field auto-mat input-auto input-auto_b must_02 must_03_02" autocomplete="off">
                    </td>
                    
                    <th class="th_01">
                        <label class="label_tag" for="±Û·ç»çÀÌÁî">»çÀÌÁî</label>
                    </th>
                    <td class="td_01">
                        <input type="text" id="±Û·ç»çÀÌÁî" class="input_tag input-field auto-mat input-auto input-auto_b must_02 must_03_03" autocomplete="off">
                    </td>
                    
                    <th class="th_01">
                        <label class="label_tag" for="±Û·çÅõÀÔ¼ö·®">ÅõÀÔ¼ö·®</label>
                    </th>
                    <td class="td_01">
                        <input type="text" id="±Û·çÅõÀÔ¼ö·®" class="input_tag input_tag_end_01 input-number must_02 must_03_04" autocomplete="off">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="td_01 td_Sremark_01" colspan="5;">
                        <input type="text" id="±Û·çºñ°í" class="input_tag input_tag_Sremark_01 input-field auto-mat" autocomplete="off">
                    </td>
                    ...
                    <td class="td_01">
                        <input type="text" id="±Û·ç·ÎÆ®¹øÈ£" class="input_tag input_tag_end_01 input-field input-auto input-auto_b" autocomplete="off">
                    </td>
                </tr>
            </table>
            ...
            <table class="ingredient_kind">
                <tr>
                    <th class="th_01">
                        <label class="label_tag label_tag_ingredient_01" for="¿ø´ÜÇ°¸í1">ÅõÀÔÇ°¸í</label>
                    </th>

                    <th class="th_01">
                        <label class="label_tag label_tag_ingredient_01" for="¿ø´ÜÄ®¶ó1">Ä®¶ó</label>
                    </th>

                    <th class="th_01">
                        <label class="label_tag label_tag_ingredient_01" for="¿ø´Ü»çÀÌÁî1">»çÀÌÁî</label>
                    </th>

                    <th class="th_01">
                        <label class="label_tag label_tag_ingredient_01" for="½Ç¼ö·®1">ÅõÀÔ¼ö·®</label>
                    </th>
                    ...
                    <th class="th_01">
                        <label class="label_tag label_tag_remark">ºñ°í</label>
                    </th>
                </tr>

                <tr>
                    <td class="td_01 td_cut_01">
                        <input type="text" id="¿ø´ÜÇ°¸í1" class="input_tag input_tag_ingredient_01 input-field auto-mat input-auto input-auto_a must_02 must_03_01" autocomplete="off">
                    </td>

                    <td class="td_01 td_cut_01">
                        <input type="text" id="¿ø´ÜÄ®¶ó1" class="input_tag input_tag_ingredient_01 input-field auto-mat input-auto input-auto_b must_02 must_03_02" autocomplete="off">
                    </td>

                    <td class="td_01 td_cut_01">
                        <input type="text" id="¿ø´Ü»çÀÌÁî1" class="input_tag input_tag_ingredient_01 input-field auto-mat input-auto input-auto_b must_02 must_03_03" autocomplete="off">
                    </td>

                    <td class="td_01 td_cut_01">
                        <input type="text" id="½Ç¼ö·®1" class="input_tag input_tag_ingredient_01 input-number must_02 must_03_04" autocomplete="off">
                    </td>

                    <td class="td_01 td_cut_01">
                        <input type="text" id="¿ø´Ü·ÎÆ®¹øÈ£1" class="input_tag input_tag_ingredient_01 input-field input-auto input-auto_b" autocomplete="off">
                    </td>

                    <td class="td_01 td_cut_01">
                        <input type="text" id="¿ø´Üºñ°í1" class="input_tag input_tag_ingredient_02 input-field auto-mat" autocomplete="off">
                    </td>
                </tr>

                <tr>
                    <td class="td_01 td_cut_01">
                        <input type="text" id="¿ø´ÜÇ°¸í2" class="input_tag input_tag_ingredient_01 input-field auto-mat input-auto input-auto_a must_03_01" autocomplete="off">
                    </td>

                    <td class="td_01 td_cut_01">
                        <input type="text" id="¿ø´ÜÄ®¶ó2" class="input_tag input_tag_ingredient_01 input-field auto-mat input-auto input-auto_b must_03_02" autocomplete="off">
                    </td>

                    <td class="td_01 td_cut_01">
                        <input type="text" id="¿ø´Ü»çÀÌÁî2" class="input_tag input_tag_ingredient_01 input-field auto-mat input-auto input-auto_b must_03_03" autocomplete="off">
                    </td>

                    <td class="td_01 td_cut_01">
                        <input type="text" id="½Ç¼ö·®2" class="input_tag input_tag_ingredient_01 input-number must_03_04" autocomplete="off">
                    </td>

                    <td class="td_01 td_cut_01">
                        <input type="text" id="¿ø´Ü·ÎÆ®¹øÈ£2" class="input_tag input_tag_ingredient_01 input-field input-auto input-auto_b" autocomplete="off">
                    </td>

                    <td class="td_01 td_cut_01">
                        <input type="text" id="¿ø´Üºñ°í2" class="input_tag input_tag_ingredient_02 input-field auto-mat" autocomplete="off">
                    </td>
                </tr>

                <tr>
                    <td class="td_01 td_cut_01">
                        <input type="text" id="¿ø´ÜÇ°¸í3" class="input_tag input_tag_ingredient_01 input-field auto-mat input-auto input-auto_a must_03_01" autocomplete="off">
                    </td>

                    <td class="td_01 td_cut_01">
                        <input type="text" id="¿ø´ÜÄ®¶ó3" class="input_tag input_tag_ingredient_01 input-field auto-mat input-auto input-auto_b must_03_02" autocomplete="off">
                    </td>

                    <td class="td_01 td_cut_01">
                        <input type="text" id="¿ø´Ü»çÀÌÁî3" class="input_tag input_tag_ingredient_01 input-field auto-mat input-auto input-auto_b must_03_03" autocomplete="off">
                    </td>

                    <td class="td_01 td_cut_01">
                        <input type="text" id="½Ç¼ö·®3" class="input_tag input_tag_ingredient_01 input-number must_03_04" autocomplete="off">
                    </td>

                    <td class="td_01 td_cut_01">
                        <input type="text" id="¿ø´Ü·ÎÆ®¹øÈ£3" class="input_tag input_tag_ingredient_01 input-field input-auto input-auto_b" autocomplete="off">
                    </td>

                    <td class="td_01 td_cut_01">
                        <input type="text" id="¿ø´Üºñ°í3" class="input_tag input_tag_ingredient_02 input-field auto-mat" autocomplete="off">
                    </td>
                </tr>

                <tr>
                    <td class="td_01 td_cut_01">
                        <input type="text" id="¿ø´ÜÇ°¸í4" class="input_tag input_tag_ingredient_01 input-field auto-mat input-auto input-auto_a must_03_01" autocomplete="off">
                    </td>

                    <td class="td_01 td_cut_01">
                        <input type="text" id="¿ø´ÜÄ®¶ó4" class="input_tag input_tag_ingredient_01 input-field auto-mat input-auto input-auto_b must_03_02" autocomplete="off">
                    </td>

                    <td class="td_01 td_cut_01">
                        <input type="text" id="¿ø´Ü»çÀÌÁî4" class="input_tag input_tag_ingredient_01 input-field auto-mat input-auto input-auto_b must_03_03" autocomplete="off">
                    </td>

                    <td class="td_01 td_cut_01">
                        <input type="text" id="½Ç¼ö·®4" class="input_tag input_tag_ingredient_01 input-number must_03_04" autocomplete="off">
                    </td>

                    <td class="td_01 td_cut_01">
                        <input type="text" id="¿ø´Ü·ÎÆ®¹øÈ£4" class="input_tag input_tag_ingredient_01 input-field input-auto input-auto_b" autocomplete="off">
                    </td>

                    <td class="td_01 td_cut_01">
                        <input type="text" id="¿ø´Üºñ°í4" class="input_tag input_tag_ingredient_02 input-field auto-mat" autocomplete="off">
                    </td>
                </tr>
            </table>
            ...
            <table class="remark">
                <tr>
                    ...
                    <td class="td_01 td_Lremark_01">
                        <textarea id="Æ¯ÀÌ»çÇ×" type="textarea" class="input_tag input_tag_Lremark_01 input-field" autocomplete="off" spellcheck="false"></textarea>
                    </td>
                </tr>
            </table>
        </div>
	...
	<div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" id="modal-header">
                <h5 class="modal-title" id="progressModalLabel" style="font-size: 16px;font-weight: 900;">Á¶È¸ÁßÀÔ´Ï´Ù. Àá½Ã¸¸ ±â´Ù·ÁÁÖ¼¼¿ä.</h5>
            </div>
